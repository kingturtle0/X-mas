...
import { AvatarImg, Name } from './profile-avatar';
...
const Advertisement = styled.a`
  ...
  &:hover {
    background-color: rgba(39, 86, 83, 0.6);
  }
`;
  ...
  return (
    <Wrapper>
      <Menu>
        ...
        <MenuLink to='/not-yet'>
          <MenuItem $isSelected={pathname === '/not-yet'}>
            {pathname === '/not-yet' ? (
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
        ...
        <ProfileWrapper>
          ...
          <ProfileButton className='post'>🎄 Post</ProfileButton>
